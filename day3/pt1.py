...
collisions = checkCollisions(path1, path2)
collisions.sort(key = lambda x: abs(x[0]) + abs(x[1]))
print(abs(collisions[1][0]) + abs(collisions[1][1])) # [1] because there's a (0, 0) that doesn't count but I didn't remove it
